...
client.on('ready', function(){
    ...
    setInterval(function (){
        ...
        i = i+j;
        client.user.setGame(setGame[i],`http://www.twitch.tv/kotugaming`);
    }, ms);
...
${prefix}infsrvr/يعرض لك معلومات عن السيرفر
...
**
${prefix}سحب @user /  لسحب الشخص الى روومك
${prefix}رسالة جماعية / رسالة جماعية الى كل اعضاء السيرفر
...
${prefix}مسح <numbr> / مسح الشات بعدد
${prefix}مسح / مسح الشات
${prefix}ميوت @user <time> / اعطاء العضو ميوت 
${prefix}فكميوت @user / لفك الميوت عن الشخص 
${prefix}طرد @user <reason> / طرد الشخص من السيرفر
${prefix}حظر @user <reason> / حضر الشخص من السيرفر
...
${prefix}انشاء شات <name> / انشاء شات
${prefix}انشاء روم <name> / انشاء رووم فويس
${prefix}temp / لانشاء روم مؤقت
${prefix}حذف <name> / مسح الشات او الرووم فويس
${prefix}الوان <number> / ينشا لك الوان مع كم الوان تبي
${prefix}لون <number> / لختيار لون
${prefix}مسح الوان <number> / لحذف الالوان
**
   `,`
        ***__Music orders__***
**
...
${prefix}*listmusic / لمعرفة قآئمة التشغيل
**
        ***__Games orders__***
 **       
${prefix}7ajar / حجر ورقة مقص
